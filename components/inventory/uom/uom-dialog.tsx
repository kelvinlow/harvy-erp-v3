...
export function UOMDialog({ open, onOpenChange, uom, uoms, onSubmit }: UOMDialogProps) {
  const [isSubmitting, setIsSubmitting] = React.useState(false);
  const [activeTab, setActiveTab] = React.useState('details');
  const [relationships, setRelationships] = React.useState<UOMRelationship[]>(uom?.relationships || []);
      ...
      <DialogContent className="max-w-2xl">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="details" className="space-y-4">
            <Form {...form}>
              <form id="uom-form" onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
                <FormField
          ...
          <TabsContent value="relationships">
            <div className="space-y-4">
              <div className="rounded-md border p-4">
                <h3 className="text-sm font-medium mb-3">Add New Relationship</h3>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        ...
                        disabled={!newRelationship.toUOMId || !newRelationship.conversionRate}
                      >
                ...
                <div className="mt-2 text-sm text-muted-foreground">
                  {newRelationship.toUOMId && newRelationship.conversionRate ? (
                    ...
                    <p>Select a UOM and enter a conversion rate to create a relationship</p>
                  )}
                </div>
              </div>
