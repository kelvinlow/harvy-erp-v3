                ...
                <>
                  ...
                  {station.items.map((item) => (
                    <TableRow key={item.machineNo}>
                      ...
                      <TableCell className="text-right">{(item.mtd.direct + item.mtd.normal).toFixed(2)}</TableCell>
                  ...
                  <TableRow>
                    ...
                    <TableCell className="text-right font-medium">{stationTotal.mtd.direct.toFixed(2)}</TableCell>
                    <TableCell className="text-right font-medium">{stationTotal.mtd.normal.toFixed(2)}</TableCell>
                    <TableCell className="text-right font-medium">
                      {(stationTotal.mtd.direct + stationTotal.mtd.normal).toFixed(2)}
                    </TableCell>
                    <TableCell className="text-right font-medium">{stationTotal.ytd.direct.toFixed(2)}</TableCell>
